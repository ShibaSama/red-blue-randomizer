...
public class RandomizerUI {
  ...
  private void initialize() {
              ...
              try {
                ...
                if (!randomizer.isPokemonRedBlue()) {
                  JOptionPane.showMessageDialog(
                      null, "Warning: This doesn't look like a Pokemon Red or Blue ROM...");
                }
    ...
    panel.setBorder(
        new TitledBorder(null, "Randomize", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    panel_1.setBorder(
        new TitledBorder(
            null, "Randomization Options", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent arg0) {
            try {
              ...
              JOptionPane.showMessageDialog(
                  null,
                  "An error occurred during randomization. Please check your rom and try again.");
              e.printStackTrace();
            }
          }
        });
        ...
        groupLayout
            ...
            .addGroup(
                groupLayout
                    ...
                    .addContainerGap()
                    .addComponent(
                        panel, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(ComponentPlacement.RELATED)
                    .addComponent(
                        panel_1, GroupLayout.PREFERRED_SIZE, 95, GroupLayout.PREFERRED_SIZE)
                    .addGap(8)
                    .addComponent(
                        randomizeButton,
